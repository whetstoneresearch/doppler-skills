---
name: v4-dutch-auction
description: Reference for Doppler V4 Dutch auctions. Use when working with `Doppler`, epoch-based rebalancing, tick accumulator logic, slug placement, or Dutch auction exit conditions.
metadata:
  author: doppler
  version: "2.0"
---
...
- Debugging why a Dutch auction rebalanced, exited early, or entered insufficient-proceeds mode
